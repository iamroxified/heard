        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
            ...
            <div class="space-y-6">
                ...
                <div class="flex space-x-4">
                    <a href="https://www.linkedin.com/company/heardinafrica/" class="h-10 w-10 rounded-full border border-gray-700 flex items-center justify-center text-gray-400 hover:border-accent hover:text-accent transition-colors">
                    ...
                    <a href="https://www.instagram.com/heard.inafrica" class="h-10 w-10 rounded-full border border-gray-700 flex items-center justify-center text-gray-400 hover:border-accent hover:text-accent transition-colors">
            ...
            <!-- Quick Links -->
            <div>
                <h3 class="text-xs font-bold uppercase tracking-wider text-gold mb-6">Quick Links</h3>
            ...
            <!-- Contact -->
            <div>
                <h3 class="text-xs font-bold uppercase tracking-wider text-gold mb-6">Contact</h3>
                <ul class="space-y-4 text-sm text-gray-400">
                    ...
                    <li class="flex items-start gap-3">
                        ...
                        <span>Lagos,<br>Nigeria</span>
                    </li>
                </ul>
            </div>
            <!-- Newsletter -->
            <div>
                <h3 class="text-xs font-bold uppercase tracking-wider text-gold mb-6">Newsletter</h3>
                <p class="text-sm text-gray-400 mb-4">Stay updated with our latest programs and speakers.</p>
                <form class="space-y-3">
                    <input type="email" placeholder="Enter your email" class="w-full bg-white/5 border border-white/10 px-4 py-3 text-sm text-white placeholder-gray-500 focus:outline-none focus:border-gold focus:ring-1 focus:ring-gold transition-all">
                    <button type="submit" class="w-full bg-gold hover:bg-white text-dark font-bold uppercase tracking-wider text-sm py-3 transition-colors">
                        Subscribe
                    </button>
                </form>
            </div>
